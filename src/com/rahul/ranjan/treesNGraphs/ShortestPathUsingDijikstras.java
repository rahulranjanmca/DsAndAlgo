...
public class ShortestPathUsingDijikstras {
	...
	public static void main(String[] args) throws Exception {
		...
		InputStream is = ShortestPathUsingDijikstras.class.getResourceAsStream(ShortestPathUsingDijikstras.class.getSimpleName() + ".txt");
		if (is == null) {
